    ...
    <>
      <div className='text-center mx-auto max-w-[630px] lg:max-w-[800px]'>
        ...
        <p className='text-gray-300 pb-10'>
          Copia el contexto y regresa al inicio para seguir con el proceso.
        </p>
      </div>
      <div>
        {responseText && (
          <div className='flex items-start gap-2.5 w-full pb-10'>
            <div className='flex flex-col gap-1 w-full max-w-[720px] mx-auto'>
              ...
              <div className='flex flex-col md:flex-row gap-y-5 md:gap-y-0  items-center justify-between pt-5'>
                <span className='inline-flex items-center gap-x-1 justify-center rounded-full bg-amber-100 px-2.5 py-1 text-amber-700'>
                  <svg
                    ...
                    className='hidden xs:flex size-5'
                  >
                    <path d='M0 0h24v24H0z' stroke='none' />
                    <path d='M3 12a9 9 0 1 0 18 0 9 9 0 0 0-18 0M12 8v4M12 16h.01' />
                  </svg>

                  <p className='text-xs break-words text-center xs:text-left'>
